...
<head>
  ...
  <meta name="description" content="CofPhe">
  <meta name="keywords" content="CofPhe">
  <meta name="author" content="CofPhe">
            ...
            <div class="middle-box">
              <div class="location-box">
                <button class="btn location-button" data-bs-toggle=""
                  ...
                  <span class="locat-name">Mời bạn đọc điều khoản và điều kiện của chúng tôi.</span>
...
<!-- term in section start -->
<section class="log-in-section background-image-2 section-b-space">
  <div class="container">
    <h2 style="font-weight: bold;">Chấp nhận Điều khoản và Điều kiện</h2>

    <p>
      a. Bằng cách đăng ký tài khoản trên trang web của chúng tôi, bạn đồng ý tuân thủ và chấp nhận các điều khoản và điều kiện sau đây.
    </p>
    <p>
      b. Bất kỳ việc vi phạm các điều khoản và điều kiện này có thể dẫn đến việc chúng tôi tạm ngừng hoặc chấm dứt tài khoản của bạn.
    </p>

    <h3>Tài khoản và thông tin cá nhân</h3>

    <p>
      a. Bạn chịu trách nhiệm duy trì tính bảo mật của tài khoản của mình và không được chia sẻ thông tin đăng nhập của bạn với bất kỳ ai khác.
    </p>

    <p>
      b. Bạn chịu trách nhiệm cung cấp thông tin cá nhân chính xác và đầy đủ trong quá trình đăng ký tài khoản.
    </p>

    <p>
      c. Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn theo Chính sách bảo mật của chúng tôi.
    </p>

    <h3>Điều kiện thanh toán</h3>

    <p>
      a. Bằng cách đăng ký tài khoản, bạn đồng ý thanh toán đầy đủ cho tất cả các sản phẩm và dịch vụ mà bạn mua từ cửa hàng trực tuyến của chúng tôi.
    </p>

    <p>
      b. Chúng tôi chấp nhận các phương thức thanh toán sau: Chuyển khoản qua mã QR hoặc nhận hàng từ shipper sau đó chuyển khoản cho shipper.
    </p>

    <h3>Quyền sở hữu trí tuệ</h3>

    <p>
      a. Tất cả các nội dung hiển thị trên trang web, bao gồm nhưng không giới hạn đến hình ảnh, đồ họa, biểu tượng, logo, âm thanh, video, văn bản và thiết kế, thuộc sở hữu của chúng tôi hoặc các bên thứ ba liên quan.
    </p>

    <p>
      b. Bạn không được sao chép, tái bản, phân phối hoặc sử dụng bất kỳ nội dung nào từ trang web của chúng tôi mà không có sự cho phép trước bằng văn bản từ chúng tôi hoặc chủ sở hữu tương ứng.
    </p>

    <h3>Cấm sử dụng trái phép</h3>

    <p>
      a. Bạn cam kết không sử dụng tài khoản của mình hoặc trang web của chúng tôi cho bất kỳ mục đích trái phép, lừa đảo, xâm phạm quyền riêng tư hoặc gây hại cho người khác.
    </p>

    <p>
      b. Bất kỳ hành vi vi phạm quyền sở hữu trí tuệ, bản quyền, hoặc luật pháp áp dụng khác có thể dẫn đến việc chúng tôi tạm ngừng hoặc chấm dứt tài khoản của bạn.
    </p><br>
    <div>
    <a href="signup" style="font-weight: bold;color: #23adad ; font-size: larger" >Tiếp tục trở về đăng ký</a>
  </div>
  </div>
