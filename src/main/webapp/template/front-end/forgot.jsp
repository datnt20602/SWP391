                                ...
                                <div>
                                    <div class="timer-notification">
                                        <h6>Something you love is now on sale!
                                            <a href="home.jsp" class="text-white">Buy Now
                                                !</a>
                                        </h6>
                                    </div>
                                </div>
                                ...
                                <ul class="category-list">
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/vegetable.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/cup.svg" alt="">
                                            <h6>Beverages</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/meats.svg" alt="">
                                            <h6>Meats & Seafood</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/breakfast.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/frozen.svg" alt="">
                                            <h6>Frozen Foods</h6>
                                            <i class="fa-solid fa-angle-right"></i>
                                        </a>
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/biscuit.svg" alt="">
                                    ...
                                    <li class="onhover-category-list">
                                        <a href="javascript:void(0)" class="category-name">
                                            <img src="${pageContext.request.contextPath}/template/assets/svg/1/grocery.svg" alt="">
                                        ...
                                        <ul class="navbar-nav">
                                            ...
                                            <li class="nav-item dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="home.jsp">Shop Left
                                                            Sidebar</a>
                                                    </li>
                                                    <li>
                                                ...
                                                <div class="dropdown-menu dropdown-menu-2">
                                                    <div class="row">
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item" href="home.jsp">Beans
                                                                & Brinjals</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Broccoli & Cauliflower</a>

                                                            <a href="home.jsp"
                                                                class="dropdown-item">Chilies, Garlic</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Vegetables & Salads</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Gourd, Cucumber</a>

                                                            <a class="dropdown-item" href="home.jsp">Herbs
                                                                & Sprouts</a>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="home.jsp">Chilies, Garlic</a>
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="home.jsp">Potatoes & Tomatoes</a>

                                                            <a href="home.jsp" class="dropdown-item">Peas
                                                                & Corn</a>
                                                        </div>
                                                        ...
                                                        <div class="dropdown-column col-xl-3">
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="home.jsp">Asparagus & Artichokes</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Avocados & Peppers</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Broccoli & Zucchini</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Celery, Fennel & Leeks</a>

                                                            <a class="dropdown-item"
                                                                href="home.jsp">Chilies & Lime</a>
                                                        </div>
            ...
            <div class="row">
                <div class="col-xxl-6 col-xl-5 col-lg-6 d-lg-block d-none ms-auto">
                    <div class="image-contain">
                        <img src="${pageContext.request.contextPath}/template/assets/images/inner-page/forgot.png" class="img-fluid" alt="">
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="d-flex align-items-center justify-content-center h-100">
                        <div class="log-in-box">
                            ...
                            <div class="input-box">
                                <form class="row g-4" action="forgotpass" method="post">
                                    <div class="col-12">
