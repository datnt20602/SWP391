                    ...
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/2.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/3.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/4.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/5.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/6.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
                ...
                <div class="col-xxl-2 col-lg-3 col-md-4 col-6 product-box-contain">
                    <div class="product-box-3 h-100">
                        <div class="product-header">
                            <div class="product-image">
                                <a href="product-detail.jsp">
                                    <img src="${pageContext.request.contextPath}/template/assets/images/cake/product/7.png" class="img-fluid blur-up lazyload"
                                        alt="">
                                </a>
